...
function addMarker(place)
{
    ...
    // get articles
    $.getJSON(Flask.url_for("articles"), parameters, function(articles) {
        
        // check if articles available and show
        ...
        // print statement if no articles present
        {
